...
public class CowTab12 extends Fragment {

    private OnFragmentInteractionListener mListener;
    private static final String TAG = "CowTab12";
        ...
        if(nameOfSnf.equals("Buffalo")){
            ...
            if(data.getCount() != 0){
                while(data.moveToNext()){
                    list.add(new RateChartModel(data.getString(0), data.getString(12)));
            ...
            list.add(new RateChartModel(data.getColumnName(12), ""));
            if (data.getCount() != 0) {
                while (data.moveToNext()) {
                    list.add(new RateChartModel(data.getString(0), data.getString(12)));
                    //Log.d(TAG, "CowTab1: " + data.getString(0) + " " + data.getString(1));
