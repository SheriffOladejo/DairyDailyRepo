...
public class CowTab13 extends Fragment {

    private OnFragmentInteractionListener mListener;
    private static final String TAG = "CowTab13";
        ...
        if(nameOfSnf.equals("Buffalo")){
            ...
            if(data.getCount() != 0){
                while(data.moveToNext()){
                    list.add(new RateChartModel(data.getString(0), data.getString(13)));
            ...
            list.add(new RateChartModel(data.getColumnName(13), ""));
            if (data.getCount() != 0) {
                while (data.moveToNext()) {
                    list.add(new RateChartModel(data.getString(0), data.getString(13)));
                    //Log.d(TAG, "CowTab1: " + data.getString(0) + " " + data.getString(1));
