...
public class CowTab10 extends Fragment {

    private OnFragmentInteractionListener mListener;
    private static final String TAG = "CowTab10";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tab10, container, false);
        ...
        if(nameOfSnf.equals("Buffalo")){
            ...
            if(data.getCount() != 0){
                while(data.moveToNext()){
                    list.add(new RateChartModel(data.getString(0), data.getString(10)));
            ...
            list.add(new RateChartModel(data.getColumnName(10), ""));
            if (data.getCount() != 0) {
                while (data.moveToNext()) {
                    list.add(new RateChartModel(data.getString(0), data.getString(10)));
                    //Log.d(TAG, "CowTab1: " + data.getString(0) + " " + data.getString(1));
