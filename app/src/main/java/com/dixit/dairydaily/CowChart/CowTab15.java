...
public class CowTab15 extends Fragment {

    private OnFragmentInteractionListener mListener;
    private static final String TAG = "CowTab15";
        ...
        if(nameOfSnf.equals("Buffalo")){
            ...
            if(data.getCount() != 0){
                while(data.moveToNext()){
                    list.add(new RateChartModel(data.getString(0), data.getString(15)));
            ...
            list.add(new RateChartModel(data.getColumnName(15), ""));
            if (data.getCount() != 0) {
                while (data.moveToNext()) {
                    list.add(new RateChartModel(data.getString(0), data.getString(15)));
                    //Log.d(TAG, "CowTab1: " + data.getString(0) + " " + data.getString(1));
