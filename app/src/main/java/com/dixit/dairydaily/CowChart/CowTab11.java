...
public class CowTab11 extends Fragment {

    private OnFragmentInteractionListener mListener;
    private static final String TAG = "CowTab11";
        ...
        if(nameOfSnf.equals("Buffalo")){
            ...
            if(data.getCount() != 0){
                while(data.moveToNext()){
                    list.add(new RateChartModel(data.getString(0), data.getString(11)));
            ...
            list.add(new RateChartModel(data.getColumnName(11), ""));
            if (data.getCount() != 0) {
                while (data.moveToNext()) {
                    list.add(new RateChartModel(data.getString(0), data.getString(11)));
                    //Log.d(TAG, "CowTab1: " + data.getString(0) + " " + data.getString(1));
