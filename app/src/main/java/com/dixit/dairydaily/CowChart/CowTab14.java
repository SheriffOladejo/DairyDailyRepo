...
public class CowTab14 extends Fragment {

    private OnFragmentInteractionListener mListener;
    private static final String TAG = "CowTab14";
        ...
        if(nameOfSnf.equals("Buffalo")){
            ...
            if(data.getCount() != 0){
                while(data.moveToNext()){
                    list.add(new RateChartModel(data.getString(0), data.getString(14)));
            ...
            list.add(new RateChartModel(data.getColumnName(14), ""));
            if (data.getCount() != 0) {
                while (data.moveToNext()) {
                    list.add(new RateChartModel(data.getString(0), data.getString(14)));
                    //Log.d(TAG, "CowTab1: " + data.getString(0) + " " + data.getString(1));
